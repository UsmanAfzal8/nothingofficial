...
export const companyWebsite = 'https://www.nothingshop.pk'
...
export const companySupportEmail = 'support@nothingshop.pk'
...
export const companyVerificationFaqs = [
  ...
  },
  {
    ...
    answer:
      `Nothing Pakistan is operated by ${companyLegalName}, whose registered company name includes Nothing Official and whose SECP registration is published openly on this website. Customers can use this page to verify the company name, CUIN, certificate, and business information.`,
  },
  {
